...
while true; do
  ...
  echo "1. Generar HTML con dos tarjetas"
  echo "2. Salir"
  ...
  case $OPTION in
    1)
      ...
      get_card_values
      generate_card_html
      echo "Archivo HTML generado como 'cards_example.html'. Presiona Enter para continuar."
      read -r
      ;;
    ...
    *)
      echo "Opción inválida. Introduce un número del 1 al 2."
      ;;
  esac
done
