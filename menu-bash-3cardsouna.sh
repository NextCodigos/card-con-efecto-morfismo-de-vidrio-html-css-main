...
generate_triple_card_html() {
  cat <<EOF >triple_cards_example.html
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
while true; do
  ...
  echo "3. Generar HTML con tres tarjetas"
  echo "4. Salir"
  ...
  case $OPTION in
    ...
    3)
      ...
      echo "Introduce el nombre para la tercera tarjeta:"
      read -r NAME_3

      echo "Introduce el texto para la tercera tarjeta:"
      read -r TEXT_3
      generate_triple_card_html
      echo "Archivo HTML generado como 'triple_cards_example.html'. Presiona Enter para continuar."
      read -r
      ;;
